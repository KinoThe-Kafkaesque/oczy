...
# Marker-bearing teaching pairs: same facts, lexical markers prepended. Primes
# the world-model's Jaccard head; lexical detector would catch both columns.
_MARKER_BEARING_TEACH = (
...
def measure() -> float:
    try:
        ...
        for teach_query in _MARKER_BEARING_TEACH:
            wm.record_outcome(
                query=teach_query,
                proposed_answer="",
