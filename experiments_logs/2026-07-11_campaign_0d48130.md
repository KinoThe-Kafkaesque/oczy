...
- **Next mechanism-level work:** teacher ceiling diagnostics (why is
  ...
  limiting the dev delta?), and trajectory diagnostics (why does seed
  2 produce `distill_delta_holdout=0.0` while the other four produce
...
3. **R18 five-seed diagnostic — COMPLETE (2026-07-11, commit
   ...
   `specificity_delta=0.02608695652173913`. Next mechanism-level
   work: teacher ceiling, prompt-contract, and trajectory
   diagnostics. No threshold changes.
